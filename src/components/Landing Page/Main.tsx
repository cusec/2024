    ...
    >
      <BlueBorderSquareBox>
        <section className="py-8 px-8 text-center mx-auto space-y-5">
          ...
          <a href="mailto:sponsor@cusec.net" className="drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] hidden md:inline bg-[#FDF3FF] border-2 border-royalBlue ml-9 px-[85px] py-3 text-center rounded-full uppercase text-[18px] font-semibold text-royalBlue tracking-wide transition ease-in-out duration-500 hover:scale-110 hover:bg-royalBlue hover:text-white ">
            Sponsor
          </a>
        </section>
      </BlueBorderSquareBox>
