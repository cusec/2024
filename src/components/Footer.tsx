  ...
  return (
    ...
    >
      <div className="flex items-baseline space-x-4 px-6 lg:mx-24 py-4">
        ...
        <section className="flex max-[380px]:flex-wrap items-center md:text-xl">
          <span className="transition-all ease-in-out duration-500 hover:scale-110 md:hover:scale-125 px-3 max-[380px]:pb-4 md:px-4">
            <Link
          ...
          <span className="transition-all ease-in-out duration-500 hover:scale-110 md:hover:scale-125 pl-4 max-[380px]:pb-4 md:px-4">
            <Link
