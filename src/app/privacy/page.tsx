...
export default function Privacy() {
  return (
    <div className="w-full gradientGridBackground min-h-[calc(100vh+50px)] flex justify-center items-center">
      <div className="mx-6 lg:max-w-[1024px] max-w-[768px] lg:mx-24">
      <BlueBorderSquareBox>
        <main
          className={`
        ...
        >
          <Fade>
            <h1 className="font-semibold text-[28px] md:text-[40px]">Privacy Policy</h1>
          <hr className="block max-w-[3rem] md:max-w-[4rem] h-2 bg-roseQuartz mb-10" />
            <p className="font-regular md:text-[20px]">
              Your privacy is important to us. It is CUSEC's policy to respect
              your privacy regarding any information we may collect from you
              across our website, {"https://2023.cusec.net"}, and other sites we
              own and operate.
              <br />
              <br />
