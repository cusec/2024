...
export default function Privacy() {
  ...
  return (
    <div
      ...
      } lg:max-w-[1024px] max-w-[768px] mx-10 mt-14 space-y-6 py-10` }
    >
      ...
      <p className="font-regular text-[15px]">
        ...
        website, {"https://2023.cusec.net"}, and other sites we own and operate. <br /><br />
        ...
        or modification. <br /><br /> We don’t share any personally identifying information
        ...
        privacy and personal information. <br /><br /> If you have any questions about how we
        handle user data and personal information, feel free to contact us. This
        policy is effective as of 15 September 2020.
      </p>
    </div>
  );
}
