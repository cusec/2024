            ...
            <BlueBorderSquareBox>
              ...
              >
                <motion.h1
                  ...
                  className="font-semibold text-[20px] sm:text-[28px] md:text-[32px]"
                >
                  Code of Conduct
                </motion.h1>
                ...
                <motion.hr
                  ...
                  className="block max-w-[3rem] md:max-w-[4rem] h-2 bg-roseQuartz mb-10 mt-3"
                />

                <motion.p
                  {...animateInConfigText}
                  transition={transitionConfig(0.5)}
                  className="font-regular text-[10px] sm:text-[12px] md:text-[16px] my-6"
                >
                  All participants of CUSEC are expected to abide by our Code of
                  Conduct, both online and during in-person events that are
                  hosted and/or associated with CUSEC.
                </motion.p>

                <motion.h2
                  {...animateInConfigText}
                  transition={transitionConfig(0.6)}
                  className="font-semibold text-[24px] mb-2 text-purple-400"
                >
                  The Pledge
                </motion.h2>
                <motion.p
                  ...
                  className="font-regular text-[10px] sm:text-[12px] md:text-[16px] mb-8"
                >
                  In the interest of fostering an open and welcoming
                  environment, we pledge to make participation in our project
                  and our community a harassment-free experience for everyone,
                  regardless of age, body size, disability, ethnicity, gender
                  identity and expression, level of experience, nationality,
                ...
                <motion.h2
                  ...
                  className="font-semibold text-[24px] mb-2 text-roseQuartz"
                >
                  The Standards
                </motion.h2>
                ...
                <motion.ul
                  {...animateInConfigText}
                  transition={transitionConfig(0.6)}
                  className="list-disc pl-8 font-regular text-[10px] sm:text-[12px] md:text-[16px] mb-6"
                >
                ...
                <motion.ul
                  {...animateInConfigText}
                  transition={transitionConfig(0.6)}
                  className="list-disc pl-8 font-regular text-[10px] sm:text-[12px] md:text-[16px] mb-10"
                >
                  <li>
                ...
                <motion.h2
                  {...animateInConfigText}
                  transition={transitionConfig(0.6)}
                  className="font-semibold text-[24px] text-orange-400 mb-2"
                >
                  Enforcement
                </motion.h2>
                <motion.p
                  {...animateInConfigText}
                  transition={transitionConfig(0.6)}
                  className="font-regular text-[10px] sm:text-[12px] md:text-[16px] mb-6"
                >
                  Violations of the Code of Conduct may be reported by sending
                  an email to incidents@cusec.net. All reports will be reviewed
                  and investigated and will result in a response that is deemed
                  necessary and appropriate to the circumstances. Further
                  details of specific enforcement policies may be posted
                  separately. We hold the right and responsibility to remove
                  comments or other contributions that are not aligned to this
                  Code of Conduct, or to ban temporarily or permanently any
                  members for other behaviours that they deem inappropriate,
                ...
                >
                  ...
                  the conference venue as well as any conference-related social
                  events.
                </motion.p>
                <motion.p
                  {...animateInConfigText}
