...
export default function DayButton(props: DayButtonProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`text-[20px] md:text-[24px] ${textColor} transition-all ease-in-out duration-1000`}
        >
          {props.Day}
        </span>
        <span
          className={`text-[24px] md:text-[32px] -mt-1 mb-1 ${textColor} transition-all ease-in-out duration-1000`}
        >
          {props.Date}
        </span>
